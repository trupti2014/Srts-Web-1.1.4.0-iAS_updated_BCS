...
{
    public sealed class PrescriptionAddPresenter
    {
        private IPrescriptionAddView _view;
        private IPrescriptionRepository _repository;
        private IIndividualRepository _individualRepository;

        public PrescriptionAddPresenter(IPrescriptionAddView view)
        {
            _view = view;
        }
        ...
        public void FillDropDowns()
        {
            ...
            {
                _view.msg = "There are no Providers loaded in the system.  Please notify your clinic administrator.";
            }
