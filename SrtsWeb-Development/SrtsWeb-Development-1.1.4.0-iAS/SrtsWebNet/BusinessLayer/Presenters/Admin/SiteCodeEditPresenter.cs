...
namespace SrtsWeb.BusinessLayer.Presenters.Admin
{
    public sealed class SiteCodeEditPresenter
    {
        ...
        public void UpdateSite()
        {
            ...
            sce.ModifiedBy = _view.mySession.MyUserID;
        ...
        public void UpdateAddress()
        {
            ...
            sae.ModifiedBy = _view.mySession.MyUserID;
            sae.IsActive = true;
        ...
        public void DoUpdate()
        {
            ...
            siteAE.ModifiedBy = _view.mySession.MyUserID;
            ...
            if (_view.UseAddress)
            {
                ...
                mailAE.ModifiedBy = _view.mySession.MyUserID;
