...
{
    public partial class GeyesMaster : System.Web.UI.MasterPage
    {
    ...
    //            Page.Title = "DoD G-Eyes";
    //            //litlastupdated.Text = DateTime.Now.ToString("dddd, MMMM dd, yyyy");
    //            //litTitleLeft_Top.Text = DateTime.Now.ToString("dddd, MMMM dd, yyyy");
    ...
    //    {
    //        get;// { return pnlBreadCrumbsBottom; }
    //        set;// { pnlBreadCrumbsBottom = value; }
    //    }
    ...
    //    {
    //        get;// { return SiteMapPath1; }
    //        set;// { SiteMapPath1 = value; }
    //    }
    ...
    //    {
    //        Response.Redirect("~/WebForms/Account/Logout.aspx", true);
    //    }
