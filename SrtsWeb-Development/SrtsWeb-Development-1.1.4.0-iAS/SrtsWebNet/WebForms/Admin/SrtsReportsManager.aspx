            ...
            <ContentTemplate>
                   ...
                   <div style="float:left">
                    ...
                    <div id="divLabelFunctions" style="float: right; margin-top: 1px">
                        <asp:Button ID="btnSubmitTop" runat="server" CssClass="srtsButton submit" ToolTip="Print Labels for Grid Items." Text="Print" 
                        ...
                        <Columns>                         
                                ...
                                <asp:TemplateField HeaderText="Order Mailing Address">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="ShipZipCode" runat="server" Text='<%# Eval("ShipZipCode") %>'></asp:Label></br />
                                ...
                                <asp:TemplateField HeaderText="Patient Mailing Address">
                                    <ItemTemplate>
                                        <div>
                                            ...
                                            <asp:Label ID="ZipCode" runat="server" Text='<%# Eval("ZipCode") %>'></asp:Label></br />
