<%@ Page Title="" Language="C#" MasterPageFile="~/SrtsMaster.master" AutoEventWireup="true"
    CodeBehind="ExamManagementAdd.aspx.cs" Inherits="SrtsWebClinic.Exams.ExamManagementAdd" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="padding">
        ...
        <asp:RequiredFieldValidator ID="rfvDoc" runat="server" ControlToValidate="ddlDoctors"
            Display="Dynamic" ErrorMessage="Provider is required." Text="*" InitialValue="X"></asp:RequiredFieldValidator><br />
        <br />
