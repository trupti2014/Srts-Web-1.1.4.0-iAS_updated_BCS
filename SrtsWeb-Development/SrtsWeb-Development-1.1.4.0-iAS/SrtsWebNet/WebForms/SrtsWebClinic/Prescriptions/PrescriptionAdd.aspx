<%@ Page Title="" Language="C#" MasterPageFile="~/SrtsMaster.Master" AutoEventWireup="True"
    MaintainScrollPositionOnPostback="true" EnableViewState="true" CodeBehind="PrescriptionAdd.aspx.cs"
    Inherits="SrtsWebClinic.Prescriptions.PrescriptionAdd" %>
...
<asp:Content ID="Content10" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="padding">
            ...
            <table id="prescriptionDetails" runat="server">
                ...
                <tr>
                    <td style="text-align: right;">
                        <label class="prescriptionLabel">Left(OS)</label></td>
                    <td>
        ...
        <asp:Panel ID="pnlCalcValues" runat="server" Height="140px" HorizontalAlign="Center">
    ...
    <div style="text-align: center" class="srtsLabel_medium">
        ...
        <br />
        <br />
        <asp:Button ID="btnSave1" runat="server" CssClass="srtsButton" Text="Save" OnClick="btnSave1_Click" TabIndex="24" />&nbsp;
        <asp:Button ID="btnCancel1" runat="server" CssClass="srtsButton" Text="Cancel" OnClick="btnCancel1_Click" CausesValidation="False" TabIndex="25" />
    </div>
    <br />
