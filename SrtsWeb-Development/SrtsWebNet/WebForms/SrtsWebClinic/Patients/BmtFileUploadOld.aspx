<%@ Page Title="" Language="C#" MasterPageFile="~/srtsMaster.Master" AutoEventWireup="true" CodeBehind="BmtFileUploadOld.aspx.cs" 
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#<%=fUpload.ClientID%>').on('change', function () {
                ...
                $('#<%=TmpFileName.ClientID%>').val($(this).val());
            });
        });
    </script>
        ...
        <ContentTemplate>
            ...
            <div class="box_full_content">
                ...
                <div class="pageContent">
                    <asp:HiddenField ID="TmpFileName" runat="server" />
                    <div class="padding">
                        ...
                        <div style="width: 50%; margin: 0px auto; text-align: center;">
                            ...
                            <asp:Button ID="btnGetFile2" runat="server" Text="Get File" OnClick="btnGetFile_Click" />
