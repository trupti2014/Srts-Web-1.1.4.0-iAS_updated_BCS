...
namespace SrtsWeb.Presenters.Admin
{
    public sealed class FrameManagementPresenter
    {
        ...
        public void InsertFrame()
        {
            ...
            fe.ModifiedBy = _view.mySession.ModifiedBy;
            fr.InsertFrame(fe);
            ...
            fie.ForEach(x => { x.ModifiedBy = _view.mySession.ModifiedBy; x.DateLastModified = DateTime.Now; });
            ...
            fr.InsertFrameItemsEligibilityAndUnion(fe.FrameCode, fie, p, _view.mySession.ModifiedBy);

            var e = _view.Eligibilities;
            fr.InsertFrameEligibilityDemographic(fe.FrameCode, e, _view.mySession.ModifiedBy);
        }
